...
import { MOCK_TREASURIES, MOCK_LEASES, MOCK_YIELD_DATA } from "@/lib/mock-data/treasury";
...
export default function TreasuryOverview() {
  ...
  const topCounterparties = MOCK_LEASES
    .filter((l) => l.treasuryId === treasuryId && l.status === "active")
    .slice(0, 10)
  ...
  // Prepare yield chart data (7-day default)
  const chartData = MOCK_YIELD_DATA.slice(-7).map((point) => ({
